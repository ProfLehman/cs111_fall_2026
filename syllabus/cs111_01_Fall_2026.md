...
The foundation of this course is a set of **Course Competencies** representing the essential computing concepts and programming skills students should understand and be able to demonstrate independently. By the end of the course, successful students will have demonstrated their understanding across the following ten competencies.

**Computing Concepts**

* **CC-01 – Data Representation:** Binary and hexadecimal numbers, character representation, storage, file formats, and compression.
* **CC-02 – Computer Systems:** Computing history, logic, computer hardware, storage, processing, and basic computer architecture.
...
* **PY-02 – Decisions and Repetition:** Boolean expressions, decision structures, `for` loops, `while` loops, and tracing program flow.
* **PY-03 – Lists and Functions:** Creating and processing lists and designing functions using parameters and return values.
* **PY-04 – Program Design, Implementation, Testing, and Debugging:** IPO planning, algorithms, program implementation using foundational Python including decisions and repetition, test cases, debugging, and code explanation.

Each Course Competency is worth **50 points**, for a total of **500 points (50% of the course grade).**

Course Competency assessments are completed individually and are designed to demonstrate independent understanding of essential computing concepts and programming skills. Assessments may include multiple-choice questions, calculations, code tracing, short-answer questions, code writing, debugging, and other problems. Unless otherwise noted, assessments are **closed notes** and must be completed without AI or other unauthorized assistance.

Each Course Competency has **three assessment opportunities**, with the highest score recorded. Students do not need to reassess a competency if they are satisfied with their current score. A scheduled opportunity that is missed or skipped is forfeited and **does not carry forward** to a later assessment date.

| Course Competencies            | First Opportunity     | Second Opportunity    | Final Opportunity             |
| ------------------------------ | --------------------- | --------------------- | ----------------------------- |
| **CC-01, CC-02, PY-01**        | Assessment #1 — 10/2  | Assessment #2 — 10/30 | Reassessment — 12/9 or 12/16* |
| **CC-03, CC-04, PY-02**        | Assessment #2 — 10/30 | Assessment #3 — 11/23 | Reassessment — 12/9 or 12/16* |
| **CC-05, CC-06, PY-03, PY-04** | Assessment #3 — 11/23 | Reassessment — 12/9   | Final Reassessment — 12/16    |

*For competencies first assessed on 10/2 or 10/30, students may use **one** of the two end-of-semester reassessment dates for their final opportunity.
...
**Practice Activities:** Regular practice activities will help you develop the knowledge and skills needed for Course Competency assessments and Applied Projects. Most class meetings will include hands-on activities, problem solving, programming, discussion, pair work, or project development rather than extended lecture.
...
* Scheduled **Course Competency assessments and in-class presentations** do not follow the general 48-hour late-work policy. Missed assessments follow the competency assessment and reassessment policies described elsewhere in the syllabus. Arrangements for a missed presentation will be determined based on the circumstances.
...
Some course activities and projects encourage collaboration, while Course Competency assessments and other designated work must be completed independently. Students are responsible for understanding the requirements for each activity.
...
**AI tools are not permitted during Course Competency assessments unless explicitly authorized by the instructor.** These assessments are designed to measure each student's independent understanding of course concepts and programming skills.
...
The schedule below provides an overview of course topics, projects, and Course Competency assessments. Python programming will be practiced throughout the semester, even during weeks when no new Python topic is introduced.

**Course Competency Assessment Dates and Topics**
- Course Competency Assessment #1 (CC-01, CC-02, PY-01) - **10/2**
- Course Competency Assessment #3 (CC-01, CC-02, PY-02) - **10/30**
- Course Competency Assessment #4 (CC-01, CC-02, PY-03, PY-04) - **11/23**
- (optional) Course Competency Reassessment - **12/9**
- (optional) Course Competency Reassessment - **12/16**
...
| 5        | 9/28           | 9/30             | **10/2**         | Review and Practice; **Course Competency Assessment #1 - 10/2**                                         |
...
| 9        | 10/26          | 10/28            | **10/30**        | Review and Practice; **Course Competency Assessment #2 - 10/30**                                        |
...
| 13       | **11/23**      | **Thanksgiving** | **Thanksgiving** | **Course Competency Assessment #3 - 11/23**                                                             |
| 14       | 11/30          | 12/2             | 12/4             | Python Data Analysis and Visualization Project, Review, Presentation Work                             |
| 15       | 12/7           | **12/9**         | 12/11            | Ethics Presentations - **12/7** and **12/11**, **Course Competency Reassessment - 12/9**            |
| Finals   |                | **12/16**        |                  | **Final Exam Period – Final Course Competency Reassessments and Course Wrap-Up - 12/16 10:30 am**                     |
