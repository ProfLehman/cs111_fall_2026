...
Yes. I think the same compact format works well for the new course. I would keep the **Topics** column broad and put the major assessments/presentations in bold.
...
| 15       | 12/7           | **12/9**         | 12/11            | Ethics Presentations - **12/7** and **12/11**, **Core Competency Reassessment (if needed) - 12/9**            |
| Finals   |                | **12/16**        |                  | **Final Exam Period – Core Competency Reassessment (if needed) - 12/16 10:30 am**                     |
